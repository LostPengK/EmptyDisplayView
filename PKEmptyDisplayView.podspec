...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/LostPengK/PKEmptyDisplayView"
  ...
  spec.source       = { :git => "https://github.com/LostPengK/PKEmptyDisplayView.git", :tag => "#{spec.version}" }

...
Pod::Spec.new do |spec|
  ...
  spec.description  = "a light tool to show empty state,custom your own state or message or  custom view  etc."

  spec.homepage     = "https://github.com/LostPengK/EmptyDisplayView"
  ...
  spec.source       = { :git => "https://github.com/LostPengK/EmptyDisplayView.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "EmptyView/class/*"
